...
sns.heatmap(cm, annot=True, cmap='Blues', fmt='d', xticklabels=['NORMAL', 'CNV', 'DME', 'DRUSEN'],
            yticklabels=['NORMAL', 'CNV', 'DME', 'DRUSEN'])
plt.title('ResNet152 Confusion Matrix', fontweight='bold', loc='center')
plt.xlabel('Predicted label')
plt.ylabel('True label')
plt.savefig(os.path.join(save_dir, 'ResNet152_confusion_matrix.png'), dpi=dpi)
plt.close()
...
plt.title('ResNet152 ROC Curve', fontweight='bold', loc='center')
plt.legend(loc='lower right')
...
print('\nEvaluation Metrics:')
print(f'Accuracy of ResNet152: {accuracy:.4f}')
print(f'Precision of ResNet152: {precision:.4f}')
print(f'Recall of ResNet152: {recall:.4f}')
print(f'F1 Score of ResNet152: {f1:.4f}')
