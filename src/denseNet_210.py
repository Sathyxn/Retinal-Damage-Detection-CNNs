...
print('\nEvaluation Metrics:')
print(f'Accuracy of DenseNet201: {accuracy:.4f}')
print(f'Precision of DenseNet201: {precision:.4f}')
print(f'Recall of DenseNet201: {recall:.4f}')
print(f'F1 Score of DenseNet201: {f1:.4f}')
...
plt.title('DenseNet201 Confusion Matrix', fontweight='bold', loc='center')
plt.xlabel('Predicted label')
plt.ylabel('True label')
plt.savefig(os.path.join(save_dir, 'DenseNet201_confusion_matrix.png'), dpi=dpi, facecolor='white')  # Set facecolor to white for saving
plt.close()
