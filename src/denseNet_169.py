...
print('\nEvaluation Metrics:')
print(f'Accuracy of DenseNet169: {accuracy:.4f}')
print(f'Precision of DenseNet169: {precision:.4f}')
print(f'Recall of DenseNet169: {recall:.4f}')
print(f'F1 Score of DenseNet169: {f1:.4f}')
